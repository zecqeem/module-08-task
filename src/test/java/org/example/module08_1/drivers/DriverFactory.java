...
public class DriverFactory {
    ...
    public static InterfaceDriverFactory getFactory(String browser) {
        ...
        try {
            ...
            log.warn("Factory for browser '{}' not found ({}). ", browser, e.getMessage());
            throw new RuntimeException("Factory for" +browser+" browser not found. Verify you typed the correct browser.");
        }
    }
